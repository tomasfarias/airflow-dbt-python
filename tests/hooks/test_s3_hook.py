"""Unit test module for DbtS3Remote."""
import io
...
def test_upload_dbt_project_to_files(s3_bucket, s3_hook, tmpdir, test_files):
...
def test_upload_dbt_project_with_no_replace(s3_bucket, s3_hook, tmpdir, test_files):
...
def test_load_file_handle_replace_error_returns_false_on_valueerror():
    ...
    class DbtS3RemoteFakeHook(DbtS3Remote):
        def load_file(*args, **kwargs):
            raise ValueError()

    remote = DbtS3RemoteFakeHook()
